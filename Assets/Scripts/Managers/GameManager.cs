...
public class GameManager : MonoBehaviour
{
    ...
    public Text m_MessageText_descripcion;
    ...
    private void Start()
    {
        ...
        //hysics.defaultMaxDepenetrationVelocity = k_MaxDepenetrationVelocity;
    ...
    void Update()
    {
        if (Input.GetMouseButton(0) && inicio==false)
        {
            //StopAllCoroutines();
            SpawnAllTanks();
            SetCameraTargets();
    ...
    private IEnumerator RoundStarting()
    {
        ...
        m_MessageText_descripcion.text = string.Empty;
